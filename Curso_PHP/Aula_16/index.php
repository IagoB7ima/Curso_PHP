<?php
    ...
    $funcionarioCod = filter_input(INPUT_POST, "slFunconario", FILTER_SANITIZE_NUMBER_INT);
    $funcionario = "";
...
//    }
//    
//    if(isset($_POST["slFunconario"])){
//        $funcionario = $arrayNome[$_POST["slFunconario"]];
//    }
?>
<!doctype html>
<html lang="pt-br">
